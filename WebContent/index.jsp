    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		if(sessionStorage.getItem("id") != null){
    			...
    			$('.iflogin').hide();
    			$('.ti-power-off').hide();
    			$('#change').attr("href", "login-register.jsp");
    		}
    	})
            ...
            <div id="sticky-header-with-topbar" class="mainmenu__area sticky__header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-lg-2 col-6">  
                            <ul class="menu-extra">
                                <li><a id="change" href="login-register.jsp"><span class="ti-user"></span></a></li>
            ...
            <div class="container">
                ...
                <div class="htc__product__container">
               		...
               		<form id="frm"   action='main.do' >
               			<input  type='hidden'  name='action' value='mainBoard.do'>
               		<div id="searchArea">
                    ...
                    <div class="row product__list" style="">
                    	...
                    	<!-- <a href="main.do?action=productdetails.do"> -->
                    	<a href="#" onclick="productClick(${g['code']});">
                    		<img src="${g['img']}" alt="product images">
                    	</a>
                    	</div>
                    	<div class="product__hover__info">
	                    	<ul class="product__action">
	                    	<li><a data-toggle="modal" title="추가" class="quick-view modal-view detail-link" href="#"><span class="ti-plus"></span></a></li>
	                    	<li><a title="찜"><span class="ti-heart"></span></a></li>
	                    	</ul>
                    	</div>
                    	</div>
                    	<div class="product__details">
                    		 <h2><a href="#" onclick="productClick(${g['code']});">${g['name']}</a></h2> 
                    	</div>
                    	</div>
                    	</div>
