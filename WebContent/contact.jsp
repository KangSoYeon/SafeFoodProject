...
<head>
    ...
    $(function(){
    	...
    	$('#edit_personal').click(function(){
    		location.replace('contact_revise.html');
    	})
    	
    	$('#leave_site').click(function(){
    		
    		var result = confirm('ì ë§ íí´íìê² ìµëê¹?')
    		
    		if(result){
    			alert("íìíí´ê° ìë£ëììµëë¤.")
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 d-none d-md-block">
                            <nav class="mainmenu__nav  d-none d-lg-block">
                                <ul class="main__menu">
                                    <li><a href="index.html">ê³µì§ ì¬í­</a></li>
                                    <li><a href="search.html">ìí ì ë³´</a></li>
                                    <li><a href="#">ë² ì¤í¸ ì­ì·¨ ì ë³´</a></li>
                                    <li class="iflogin" style="display:none;"><a href="#">ë´ ì­ì·¨ ì ë³´</a></li>
                                    <li class="iflogin" style="display:none;"><a href="#">ìì ì­ì·¨ ì ë³´</a></li>
                                </ul>
                            </nav>
                                ...
                                <div class="contact__address__inner">
                                    ...
                                    <div class="contact__address__inner">
                                     <div class="single__contact__address">
                                        ...
                                        <div class="contact__details">
                                            <p> Allergy :<br><a href="#">ëì½©, ì°ì </a></p>
                                        </div>
                                    </div>
                                    </div>
                                    <!-- End Single alergy -->
                                    ...
                                    <div class="contact-btn" style="float: right" >
                                        <button type="submit" class="fv-btn" id = "edit_personal">ìì </button>
                                        <button type="submit" class="fv-btn" id = "leave_site">íìíí´</button>
                                    </div>
